...
class ScheduleController extends Controller
{
    ...
    public function store()
    {
        ...
        try {
            $user_settings = $schedule->user->getAllSettings();
            $maxTime = $user_settings['maxTime'];
    ...
    public function create()
    {
        ...
        return view('beautician.schedules.create', compact('wizard', 'clinic_id', 'weeks', 'slotDurations'));
    }
}
