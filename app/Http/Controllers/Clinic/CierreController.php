...
class CierreController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request('print')) {
            $cierres = $cierres->get();
            return view('clinic.cierres.print', compact('cierres', 'totales', 'impuestosVentasCompras', 'codigoActividad'));
        }

        $cierres = $cierres->paginate(500);

        return view('clinic.cierres.index', compact('cierres', 'totales', 'search', 'impuestosVentasCompras'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/clinic/cierres?start=' . Carbon::parse(request('to'))->toDateString() . '&CodigoActividad=' . request('CodigoActividad'));
    }
    ...
    public function destroy(Cierre $cierre)
    {
        ...
        return Redirect('/clinic/cierres');
    }
}
