...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'blood_ps' => 'Presión Arterial',
        'blood_pd' => 'Presión Arterial',
        'oxygen' => 'Saturación de oxigeno',
        ...
        'phone_country_code' => 'Código de región',
        'first_name' => 'Nombre',
        'last_name' => 'Apellidos',
        'gender' => 'Genero',
        'phone2' => 'Celular',
        ...
        'medic_code' => 'Código de Médico',
        'patient_id' => 'Paciente',
        'affiliation_plan_id' => 'Tipo de plan',
        'account' => 'Cuenta',
        'schedules.*.office_id' => 'Consultorio',
        'schedules.*.date' => 'Fecha',
        'schedules.*.start' => 'Desde',
        'schedules.*.end' => 'Hasta',
        'start' => 'hora de inicio',
        'end' => 'hora final',
        'voucher' => 'comprobante',
        'patient_name' => 'Nombre completo',
        'general_cost_appointment' => 'Costo Aproximado de la consulta',
        'plan_id' => 'Tipo de plan',
        'lat' => 'Latitud',
        'lon' => 'Longitud',
