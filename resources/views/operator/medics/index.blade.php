            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <form action="/operator/medics" method="GET" autocomplete="off">
                                            ...
                                            <div class="td-lugar">
                                                ...
                                                <div class="td-lugar-info">
                                                    ...
                                                    <div class="tw-flex tw-gap-2 tw-items-center">
                                                        ...
                                                        @if ($office->active)
                                                            <a href="{{ url('/operator/medics/' . $medic->id . '/offices/' . $office->id . '/agenda') }}" class="btn btn-primary btn-xs"><i class="fa fa-calendar"></i> Ver Agenda</a>
                                                        @endif
                                                        <button-agenda-print :url="'/agenda/print?medic={{ $medic->id }}'"></button-agenda-print>
                                                    </div>
                                                </div>
