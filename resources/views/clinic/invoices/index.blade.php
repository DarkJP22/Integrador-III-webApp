        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <a href="/clinic/affiliations" class="btn btn-primary">Afiliaciones</a>
                    <a href="/clinic/affiliationplans" class="btn btn-primary">Tipos de Plan Afiliaciones</a>
                    
                  @endif --}}
                        <form action="/clinic/invoices" method="GET" autocomplete="off">
                    ...
                    <div class="box-body table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                @if ($invoices)
                                    <tr>
                                        <td colspan="9" class="pagination-container">{!! $invoices->appends(['q' => $search['q'], 'start' => $search['start'], 'end' => $search['end'], 'medic' => $search['medic'], 'office' => $search['office'], 'CodigoActividad' => $search['CodigoActividad']])->render() !!}</td>
                                    </tr>
                                @endif
