	...
	<section class="content">
            ...
            <!-- Widget: user widget style 1 -->
                <div class="box box-widget widget-user-2 widget-plan">
                    ...
                    <!-- /.widget-user-image -->
                    <h3 class="widget-user-username">{{ $plan->title }}</h3>
                    <h5 class="widget-user-desc">{{ $plan->costName }}</h5>
                    </div>
                    <div class="box-body">
                        {!! $plan->description !!}
                    </div>
                    <div class="box-footer text-center">
                        ...
                        @else
                           <a href="{{ url('/clinic/subscriptions/'. $plan->id .'/change') }}" class="btn btn-primary" >Cambiar</a>
