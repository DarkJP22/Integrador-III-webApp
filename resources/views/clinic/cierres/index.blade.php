            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <form method="POST" id="form-cierre" data-confirm="Estas Seguro?" action="/clinic/cierres">
                            {{ csrf_field() }}
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <button type="submit" class="btn btn-primary" form="form-cierre" formaction="/clinic/cierres">Generar Nuevo Cierre</button>
                                </div>
                ...
                <div class="box">
                    ...
                    <div class="box-header">
                        <div class="filters">
                            ...
                            <form action="/clinic/cierres" method="GET" autocomplete="off">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h5>Consultar</h5>
                                    </div>
