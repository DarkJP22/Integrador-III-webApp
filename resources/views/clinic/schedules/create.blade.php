    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                @include('clinic.schedules._modal-wizard')
                ...
                @include('clinic.schedules._copySchedule')
            ...
            <div class="col-md-9">
                <div class="box box-default box-calendar medico-calendar">
                    <div class="box-body no-padding">
                        ...
                        <!-- THE CALENDAR -->
                        <div id="calendar" data-slotDuration="{{ $user_settings['slotDuration'] }}" data-minTime="{{ $user_settings['minTime'] }}" data-maxTime="{{ $user_settings['maxTime'] }}" data-freeDays="{{ $user_settings['freeDays'] }}" data-schedule="{{ $wizard }}" data-medic="{{ $medic->id }}" data-office="{{ $office->id }}"></div>
                    </div>
                    <!-- /.box-body -->
                </div>
                <!-- /. box -->
...
@push('scripts')
    ...
    @vite('resources/js/clinicSchedule.js')
    <script>
        $(function() {
