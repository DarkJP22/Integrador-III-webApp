        ...
        <div class="modal-content">
            ...
            <div class="modal-body" data-modaldate data-slotduration="30">
                <div class="callout callout-info">
                    ...
                    <p>Programa tu agenda buscando los consultorios o clinicas donde trabajas y asignale una fecha y
                        horas determinadas. </p>
                </div>
                <div class="content form-horizontal">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="form-group">
                                <label for="selectSlotDuration" class="cffol-sm-7 control-label">Pacientes
                                    cada: </label>
                                <div class="ffcol-sm-5">
                                    @php
                                        $user_settings = $medic->getAllSettings();
                                    @endphp
                                    <select name="selectSlotDurationModal" id="selectSlotDurationModal"
                                            class="form-control">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-8">
                            <div class="form-group">
                                <select name="search-offices" id="search-offices"
                                        class="search-offices form-control select2 " style="width: 100%;">
                                    <!-- <option value=""></option> -->
                                </select>
