            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <form action="/assistant/patients" method="GET" autocomplete="off">
                            ...
                            <table class="table table-hover">
                                ...
                                @foreach($patients as $patient)
                                    <tr>
                                        ...
                                        @if($patient->isPatientOfClinic($office))
                                            ...
                                            <td data-title="" style="padding-left: 5px;">
                                                <!-- <a href="{{ url('/general/patients/'.$patient->id) }}" class="btn btn-primary" title="Ver Facturado"><i class="fa fa-eye"></i> Información básica</a> -->
