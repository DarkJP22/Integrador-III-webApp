...
@section('content')
    <section class="content-header">
        <h1>Cierre del dia por médico</h1>
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <form method="POST" id="form-cierre" data-confirm="Estas Seguro?" action="/assistant/cierres">
                            {{ csrf_field() }}
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <button type="submit" class="btn btn-primary" form="form-cierre" formaction="/assistant/cierres">Generar Nuevo Cierre</button>
                                </div>
                ...
                <div class="box">
                    ...
                    <div class="box-header">
                        <div class="filters">
                            ...
                            <form action="/assistant/cierres" method="GET" autocomplete="off">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h5>Consultar</h5>
                                    </div>
                    ...
                    <div class="box-body table-responsive">
                        <table class="table no-margin">
                            ...
                            <tbody>
                                ...
                                @foreach ($cierres as $cierre)
                                    <tr>
                                        ...
                                        <td>
                                            @can('update', $cierre)
                                                <form method="POST" action="{{ url('/clinic/cierres/' . $cierre->id) }}" data-confirm="Estas Seguro?">
                                                    @csrf
                                                    {{ method_field('DELETE') }}
                            ...
                            <tfoot>
                                ...
                                @if (count($cierres))
                                    <tr>
                                        <td colspan="15" class="pagination-container">{!! $cierres->appends(['office' => $search['office'], 'user' => $search['user'], 'start' => $search['start'], 'end' => $search['end'], 'to' => $search['to'], 'archived' => $search['archived']])->render() !!}</td>
                                    </tr>
                                @endif
                            </tfoot>
                        </table>
