            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <form action="/pharmacy/marketing" method="GET" autocomplete="off">
                                ...
                                <div class="col-sm-3">
                                    <select name="conditions" id="conditions" class="form-control">
                                        ...
                                        @foreach($padecimientos as $padecimiento)
                                            <option value="{{ $padecimiento->name }}" {{ isset($search['conditions']) ? ($search['conditions'] == $padecimiento->name ? 'selected' : '') : '' }}>{{ $padecimiento->name }}</option>
                                        @endforeach
