    ...
    @if(isset($incomes) && $incomes)
      ...
      <!-- this row will not appear when printing -->
       <div class="row no-print">
         ...
         <form action="/pharmacy/subscriptions/renew-voucher" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          @foreach($incomes as $income)
            <input class="form-control" type="hidden" name="incomes[]" value="{{ $income->id }}" />
          @endforeach
