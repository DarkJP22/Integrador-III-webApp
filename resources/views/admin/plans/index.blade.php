          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                ...
                <a href="{{ url('/admin/plans/create') }}" class="btn btn-primary">Nuevo Plan</a>      
                <div class="box-toolsdd filters">
                  <form action="/admin/plans" method="GET" autocomplete="off">
                ...
                <table class="table table-hover">
                  ...
                  @foreach($plans as $plan)
                    <tr>
                      ...
                      <a href="{{ url('/admin/plans/'.$plan->id) }}" class="btn btn-primary" title="Editar"><i class="fa fa-edit"></i> Editar</a>
