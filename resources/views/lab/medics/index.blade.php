            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <form action="/lab/medics" method="GET" autocomplete="off">
                            ...
                            @foreach ($medics as $medic)
                                <tr>
                                    ...
                                    <td data-title="" style="padding-left: 5px;">
                                      ...
                                      @if ($office->active) 
                                        <a href="{{ url('/lab/medics/'.$medic->id.'/offices/'.$office->id .'/agenda') }}" class="btn btn-primary btn-xs"><i class="fa fa-calendar"></i> Ver Agenda</a>
                                      @endif
                                      </p> --}}
                                                </div>
