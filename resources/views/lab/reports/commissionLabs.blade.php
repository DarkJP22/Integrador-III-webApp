...
@section('content')
    <section class="content-header">
      <h1>Comisión Doctor Blue (Generado)</h1>
          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                    <form action="/lab/commission/labs" method="GET" autocomplete="off">
                        ...
                        @foreach($commissions as $commission)
                          <tr>
                                ...
                                <td>
                                  ...
                                  <form action="/lab/commissions/{{ $commission->id}}/upload-voucher" method="POST" enctype="multipart/form-data">
                                    @csrf
