    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <lab-results :patient-id="{{ $patient->id }}" :results="{{ $patient->labresults }}"
                             :medics="{{ $medics }}">Resultados de Laboratorio
                </lab-results>
            </div>
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="{{ isset($tab) ? ($tab == 'basic' ? 'active' : '') : 'active' }}"><a href="#basic"
                                ...
                                Básica</a></li>
                        <li class="{{ isset($tab) ? ($tab == 'appointments' ? 'active' : '') : '' }}"><a
                                    href="#appointments" data-toggle="tab">Consultas</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="{{ isset($tab) ? ($tab == 'appointments' ? 'active' : '') : '' }} tab-pane"
                             id="appointments">
