...
<head>
    ...
    <script>
        window.App = {!! json_encode([
            ...
            'signedIn' => Auth::check(),
            'fe' => Auth::user()->fe,
            'isMedic' => Auth::user()->isMedic(),
            'subscriptionPlanHasFe' => auth()->user()->subscriptionPlanHasFe()
        ]) !!};
    </script>
...
<div id="app" class="wrapper">
    ...
    @include('layouts.medics._header')



    @include('layouts.medics._sidebar')


    <div class="content-wrapper">
        @include('layouts.medics._information-app')
...
@vite('resources/js/onBoardingMedicsTours.js')
@stack('scripts')
</body>
</html>
