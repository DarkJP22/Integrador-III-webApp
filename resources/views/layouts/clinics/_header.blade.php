         ...
         <user-notifications></user-notifications>
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">{{ auth()->user()->name }} - Clínica: @foreach(auth()->user()->offices as $clinic) {{ $clinic->name }} @endforeach</span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>Subscripción: {{ Optional(App\Plan::find(auth()->user()->subscription->plan_id))->title }}. Exp: {{ Optional(auth()->user()->subscription->ends_at)->toDateString() }}</small>
                  @endif
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
                <div class="row">
                  <div class="col-xs-4 text-center">
                    <a href="/clinic/patients">Pacientes</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="/clinic/agenda">Agenda</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="/clinic/medics">Médicos</a>
                  </div>
                </div>
                <!-- /.row -->
              </li>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="{{ url('/clinic/profiles') }}" class="btn btn-default btn-flat">Profile</a>
                </div>
