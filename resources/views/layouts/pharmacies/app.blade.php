...
<head>
  ...
  <script>
        window.App = {!! json_encode([
            'user' => Auth::user(),
            'currentPharmacy' => Auth::user()->pharmacies->first(),
            'signedIn' => Auth::check(),
            'fe' => Auth::user()->fe,
            'isPharmacy' => Auth::user()->isPharmacy()
        ]) !!};
  </script>
...
<div id="app" class="wrapper">
  ...
  @include('layouts.pharmacies._header')



  @include('layouts.pharmacies._sidebar')




  <div class="content-wrapper">
     @include('layouts.pharmacies._information-app')
