...
<head>
  ...
  <script>
        window.App = {!! json_encode([
            'user' => Auth::user(),
            'currentOffice' => Auth::user()->offices->first(),
            'signedIn' => Auth::check(),
            'fe' => Auth::user()->fe,
...
<div id="app" class="wrapper">
  ...
  @include('layouts.laboratories._header')



  @include('layouts.laboratories._sidebar')




  <div class="content-wrapper">
    @include('layouts.laboratories._information-app')
