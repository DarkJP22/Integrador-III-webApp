...
<div class="form-group">
    ...
    <div class="col-sm-7">
        <input type="text" class="form-control" id="phone_number" name="phone_number" placeholder="Teléfono de contacto"
               value="{{ old('phone_number') ?: $profileUser->phone_number }}" required>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <input type="text" class="form-control" id="medic_code" name="medic_code" placeholder="Código de Médico" value="{{ old('medic_code') ?: $profileUser->medic_code }}"
               required>
        ...
        <select class="form-control select2" style="width: 100%;" name="speciality[]" placeholder="-- Selecciona Especialidad --" multiple>
            ...
            @foreach($specialities as $speciality)
                <option value="{{$speciality->id}}"
                        @foreach($profileUser->specialities as $s) @if($speciality->id == $s->id)selected="selected"@endif @endforeach>{{$speciality->name}}</option>
            @endforeach
...
{{--    <div class="form-group">--}}
{{--        <label for="minTime" class="col-sm-2 control-label">Costo Consulta General</label>--}}
{{--        <div class="col-sm-4">--}}

{{--            <input type="text" class="form-control"  name="general_cost_appointment" id="general_cost_appointment" value="{{ old('general_cost_appointment') ?: floatval($user_settings['general_cost_appointment']) }}">--}}
...
{{--            <div class="checkbox">--}}
{{--              <label>--}}
{{--                <input type="checkbox" name="accumulated_affiliation" value="1" {{ $profileUser->accumulated_affiliation ? 'checked' : ''}}>--}}
{{--                Afiliado a Canje de Saldos Acumulados--}}
{{--              </label>--}}
{{--            </div>--}}
{{--          </div>--}}
{{--    </div>--}}
...
{{--        <div class="checkbox">--}}
{{--            <label>--}}
{{--                <input type="checkbox" name="esteticista" value="1" {{ $profileUser->hasRole('esteticista') ? 'checked' : ''}}>--}}
{{--                Esteticista--}}
{{--            </label>--}}
{{--        </div>--}}
{{--    </div>--}}
