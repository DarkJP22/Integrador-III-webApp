...
@section('content')
  ...
  <div class="register-box-body">
    <div class="callout callout-info"><h4>Ya casi terminas!</h4> <p>Agrega los siguientes datos de la Farmacia para finalizar el registro.</p></div>
    <form method="POST" action="{{ url('/pharmacy/register/pharmacy') }}" class="form-horizontal register-patient"  enctype="multipart/form-data">
         {{ csrf_field() }}
         ...
         <div class="form-group">
            ...
            <div class="col-sm-12">
              <input type="text" class="form-control" name="name" placeholder="Nombre de la farmacia" value="{{ old('name') }}" required>
               @if ($errors->has('name'))
