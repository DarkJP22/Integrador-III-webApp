...
<div class="register-box">
  ...
  <div class="register-box-body">
    ...
    <form  role="form" method="POST" action="{{ url('/clinic/complete-payment') }}">
        {{ csrf_field() }}
      ...
      <div class="form-group has-feedback">
        <input id="name" type="text" class="form-control" name="name" value="{{ auth()->user()->name }}" readonly autofocus placeholder="Nombre del administrador de la clinica">
