    ...
    <div class="register-box">
     ...
     <a href="/"><img src="/img/logo.png" alt="{{ config('app.name', 'Laravel') }}"></a>
        ...
        <div class="register-box-body">
            <p class="login-box-msg">Registra una nueva cuenta como Administrador de Laboratorio</p>

            <form role="form" method="POST" action="{{ url('/lab/register/admin') }}">
                {{ csrf_field() }}
                ...
                <div class="form-group has-feedback">
                    <input id="name" type="text" class="form-control" name="name" value="{{ old('name') }}" required
                           autofocus placeholder="Nombre del administrador del laboratorio">
                    @if ($errors->has('name'))
                        <span class="help-block">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 has-feedback">
                        <input id="phone" type="phone" class="form-control" name="phone_number"
