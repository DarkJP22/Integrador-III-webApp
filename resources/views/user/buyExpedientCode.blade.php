      ...
      <div class="row no-print">
        <div class="col-xs-12">
            ...
            @endif
                ...
                <input class="form-control" type="hidden" name="shippingFirstName" value="{{ $name }}" />
                <input class="form-control" type="hidden" name="shippingLastName" value="--" />
                <input class="form-control" type="hidden" name="shippingEmail" value="{{ $email }}" />
                ...
                <input class="form-control" type="hidden" name="reserved2" value="{{ auth()->user()->id }}" />
                <input class="form-control" type="hidden" name="reserved3" value="" />
