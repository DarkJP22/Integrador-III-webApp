$(function () {
    ...
    calendar.fullCalendar({
        ...
        eventDrop: function (event, delta, revertFunc) {
            ...
            // let start = moment(event.start).set('year', year).set('month', month).set('date', day).stripZone().format()//format('YYYY-MM-DD HH:mm');
            // let end = moment(event.end).year(year).month(month).day(day).stripZone().format()//format('YYYY-MM-DD HH:mm');
    ...
    function loadSchedules() {
        ...
        axios.get('/assistant/schedules/monthly?office='+ calendar.data('office') +'from=' + from + '&to=' + to)
            .then(({ data }) => {
