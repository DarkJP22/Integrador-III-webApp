$(function () {
    ...
    function onChangeSlotDurarion(slotDuration) {
        ...
        $.ajax({
            type: 'PUT',
            url: '/users/'+ calendar.data('medic') +'/settings',
            dataType:'json',
            data: { slotDuration: slotDuration },
            success: function () {

                console.log('slotDuration actualizado');
                window.location.href = '/clinic/medics/'+ calendar.data('medic') +'/schedules/create';
    ...
    function fetch_offices() {
        ...
        $.ajax({
            type: 'GET',
            url: '/medics/'+ calendar.data('medic') +'/calendars/offices',
            dataType: 'json',
            data: {},
            success: function (resp) {
                ...
                $.each(resp, function (index, item) {
                    console.log(index);
                    if(item.id == calendar.data('office')){ // solo mostrar la de la clinica de la secretaria
    ...
    function initCalendar(appointments) {
        ...
        calendar.fullCalendar({
            ...
            eventDrop: function (event, _delta, revertFunc) {
                var currentDate = new Date();
            ...
            eventRender: function (event, element) {
                ...
                element.find('.appointment-details').click(function () {
                    ...
                    Swal.fire({
                        ...
                        html: textAlert,
                        showCancelButton: true,
                        showConfirmButton: calendar.data('office') == office_id ? true : false,
                        confirmButtonColor: '#d33',
                        cancelButtonColor: '#67BC9A',
                        cancelButtonText: 'Ok',
            ...
            viewRender: function (view) {
                ...
                $.ajax({
                    ...
                    url:'/medics/' + calendar.data('medic') + '/calendars/schedules?&date1=' + view.start.format() + '&date2=' + view.end.format(),
                    data: {},
                    success: function (resp) {
                        ...
                        $.each(resp, function (index, item) {
                            ...
                            if(item.office_id != calendar.data('office')) item.rendering = 'background';
    ...
    setupSchedule.find('.add-cita').on('click', function (e) {
        ...
        var currColor = '#67BC9A';//colors[Math.floor((Math.random() * colors.length))];
        ...
        ajax: {
            ...
            processResults: function (data) {
                ...
                $.each(data, function (index, value) {
                    if(value.id == calendar.data('office')){ // solo mostrar el de la clinica de la secretaria
                        const item = {
                            id: value.id,
                            text: value.name,
