    ...
    function initCalendar(appointments/*, schedules*/) {
        ...
        calendar.fullCalendar({
            ...
            viewRender: function (view) {
                ...
                $.ajax({
                    type: 'GET',
                    url: '/medics/' + calendar.data('medic') + '/calendars/schedules?office=' + calendar.data('office') + '&date1=' + view.start.format() + '&date2=' + view.end.format(),
                    data: {},
                ...
                $.ajax({
                    type: 'GET',
                    url: '/medics/' + calendar.data('medic') + '/calendars/appointments?calendar=1&office=' + calendar.data('office') + '&date1=' + view.start.format() + '&date2=' + view.end.format(),
                    data: {},
                    success: function (resp) {
                        ...
                        $.each(resp, function (index, item) {
                            ...
                            if (item.user_id != calendar.data('medic')) {
