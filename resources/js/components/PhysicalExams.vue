        ...
        <div class="panel box box-default">
          ...
          <div id="cardio" class="panel-collapse collapse" :class="(physical_exams.cardio) ? 'in' : '' " aria-expanded="false">
            <div class="box-body">
              ...
              <textarea name="cardio" cols="30" rows="3" class="form-control" v-model="physical_exams.cardio" @keydown="keydown()" :readonly="finishedRevalorizar"></textarea>
        ...
        <div class="panel box box-default">
          ...
          <div id="linfatico" class="panel-collapse collapse" :class="(physical_exams.linfatico) ? 'in' : '' " aria-expanded="false">
            <div class="box-body">
              ...
              <textarea name="linfatico" cols="30" rows="3" class="form-control" v-model="physical_exams.linfatico" @keydown="keydown()" :readonly="finishedRevalorizar"></textarea>
        ...
        <div class="panel box box-default">
          ...
          <div id="osteoarticular" class="panel-collapse collapse" :class="(physical_exams.osteoarticular) ? 'in' : '' " aria-expanded="false">
            <div class="box-body">
              ...
              <textarea name="osteoarticular" cols="30" rows="3" class="form-control" v-model="physical_exams.osteoarticular" @keydown="keydown()" :readonly="finishedRevalorizar"></textarea>
        ...
        <div class="panel box box-default">
          ...
          <div id="psiquiatrico" class="panel-collapse collapse" :class="(physical_exams.psiquiatrico) ? 'in' : '' " aria-expanded="false">
            <div class="box-body">
              ...
              <textarea name="psiquiatrico" cols="30" rows="3" class="form-control" v-model="physical_exams.psiquiatrico" @keydown="keydown()" :readonly="finishedRevalorizar"></textarea>
        ...
        <div class="panel box box-default">
          ...
          <div id="digestivo" class="panel-collapse collapse" :class="(physical_exams.digestivo) ? 'in' : '' " aria-expanded="false">
            <div class="box-body">
              ...
              <textarea name="cardio" cols="30" rows="3" class="form-control" v-model="physical_exams.digestivo" @keydown="keydown()" :readonly="finishedRevalorizar"></textarea>
        ...
        <div class="panel box box-default">
          ...
          <div id="dermatologico" class="panel-collapse collapse" :class="(physical_exams.dermatologico) ? 'in' : '' " aria-expanded="false">
            <div class="box-body">
              ...
              <textarea name="dermatologico" cols="30" rows="3" class="form-control" v-model="physical_exams.dermatologico" @keydown="keydown()" :readonly="finishedRevalorizar"></textarea>
        ...
        <div class="panel box box-default">
          ...
          <div id="otorrinolaringologico" class="panel-collapse collapse" :class="(physical_exams.otorrinolaringologico) ? 'in' : '' " aria-expanded="false">
            <div class="box-body">
              ...
              <textarea name="otorrinolaringologico" cols="30" rows="3" class="form-control" v-model="physical_exams.otorrinolaringologico" @keydown="keydown()" :readonly="finishedRevalorizar"></textarea>
        ...
        <div class="panel box box-default">
          ...
          <div id="reproductor" class="panel-collapse collapse" :class="(physical_exams.reproductor) ? 'in' : '' " aria-expanded="false">
            <div class="box-body">
              ...
              <textarea name="reproductor" cols="30" rows="3" class="form-control" v-model="physical_exams.reproductor" @keydown="keydown()" :readonly="finishedRevalorizar"></textarea>
        ...
        <div class="panel box box-default">
          ...
          <div id="urinario" class="panel-collapse collapse" :class="(physical_exams.urinario) ? 'in' : '' " aria-expanded="false">
            <div class="box-body">
              ...
              <textarea name="urinario" cols="30" rows="3" class="form-control" v-model="physical_exams.urinario" @keydown="keydown()" :readonly="finishedRevalorizar"></textarea>
        ...
        <div class="panel box box-default">
          ...
          <div id="neurologico" class="panel-collapse collapse" :class="(physical_exams.neurologico) ? 'in' : '' " aria-expanded="false">
            <div class="box-body">
              ...
              <textarea name="neurologico" cols="30" rows="3" class="form-control" v-model="physical_exams.neurologico" @keydown="keydown()" :readonly="finishedRevalorizar"></textarea>
        ...
        <div class="panel box box-default">
          ...
          <div id="pulmonar" class="panel-collapse collapse" :class="(physical_exams.pulmonar) ? 'in' : '' " aria-expanded="false">
            <div class="box-body">
              ...
              <textarea name="pulmonar" cols="30" rows="3" class="form-control" v-model="physical_exams.pulmonar" @keydown="keydown()" :readonly="finishedRevalorizar"></textarea>
...
export default {
    ...
    methods: {
        ...
        update() {
            ...
            axios.put('/physicalexams/' + this.physical.id, this.physical_exams)
                .then(() => {
                    this.emitter.emit('actSummaryExams', this.physical_exams);
