                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" data-modaldate data-modaldate-end>
                        <div class="box-widget widget-user-2" v-show="!newPatient"
                             ...
                             v-bind:data-office="office ? office : ''" v-bind:data-medic="selectedMedic"
                             v-bind:data-optreatments="estreatmentIds">
                            <div class="form-group">
                                <select name="medic_id" id="medic_id" v-model="selectedMedic" class="form-control"
                                        required>
                                    <option value="">-- Seleccione un médico --</option>
                                    <option :value="item.id" v-for="(item, index) in medics"
                    ...
                    <div class="modal-footer" v-show="!newPatient">
                        ...
                        <button type="button" class="btn btn-primary btn-finalizar-cita">
                            Crear cita
                        </button>
...
export default {
    ...
    methods: {
        ...
        getMedicsOffice() {
            if (this.office) {
                axios.get('/offices/' + this.office + '/medics').then(({data}) => {
                    this.medics = data;
                });
            }
        },
    ...
    created() {
        ...
        this.emitter.on('openModalClinicNewAppointmentRoom', () => {
            this.selectedMedic = '';
        });
